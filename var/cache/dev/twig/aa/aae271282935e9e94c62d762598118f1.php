...
/* car/index.html.twig */
class __TwigTemplate_27b52f7bf6a9aca6e085dfc01b006ab2 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if ((twig_length_filter($this->env, (isset($context["cars"]) || array_key_exists("cars", $context) ? $context["cars"] : (function () { throw new RuntimeError('Variable "cars" does not exist.', 14, $this->source); })())) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["car"]) {
                // line 16
                echo "      <a href=";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_car_show", ["car" => twig_get_attribute($this->env, $this->source, $context["car"], "id", [], "any", false, false, false, 16)]), "html", null, true);
                echo ">
        ";
                // line 17
                echo twig_include($this->env, $context, "car/_car_item.html.twig", ["car" => $context["car"]]);
                echo "
      </a>
    ";
                ++$context['loop']['index0'];
...
<div class=\"grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4\">
  {% if cars|length > 0 %}
    {% for car in cars %}
      <a href={{ path('app_car_show', {car: car.id}) }}>
        {{ include('car/_car_item.html.twig', {car: car}) }}
      </a>
    {% endfor %}
  {% else %}
...
{% endblock %}
", "car/index.html.twig", "/home/alex/SE/data_warehouse/templates/car/index.html.twig");
    }
}
